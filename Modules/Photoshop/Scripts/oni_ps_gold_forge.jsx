...
try {
    ...
    var width = 1920;
    var height = 1080;
    var doc = app.documents.add(width, height, 72, "ONI_GOLD_ASSET", NewDocumentMode.RGB, DocumentFill.BLACK);
    ...
    // 4. SAVE - Dynamic path resolution
    var _scriptFile = new File($.fileName);
    var _oniRoot = _scriptFile.parent.parent.parent.parent.fsName.replace(/\\/g, "/");
    var _assetsDir = _oniRoot + "/assets";
    var assetsFolder = new Folder(_assetsDir);
    if (!assetsFolder.exists) assetsFolder.create();

    var file = new File(_assetsDir + "/ONI_GOLD_ASSET.psd");
