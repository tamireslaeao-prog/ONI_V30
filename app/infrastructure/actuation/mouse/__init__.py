# -*- coding: utf-8 -*-
"""
ONI Mouse Control Library
==========================

Cross-platform mouse control with event hooking and automation capabilities.

## Features

- Global event hook on all mice devices (captures events regardless of focus).
- **Listen** and **send** mouse events.
- Works with **Windows**, **Linux**, and **MacOS**.
- **Pure Python**, no C modules to be compiled.
- **Zero external dependencies** on Windows and Linux.
- **Python 2 and 3** compatible.
- Includes **high level API** for recording and playback.
...
- Linux implementation reads raw device files (`/dev/input/input*`) which requires root.
- Some applications may register hooks that prevent event reporting.
"""
# TODO
# - infinite wait
# - mouse.on_move
