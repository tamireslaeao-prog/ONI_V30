...
try:
    ...
    # Fallback to prevent import error if Pillow is not installed
    pass
...
class BoxAnnotator:
    ...
    def draw_boxes(
        self, image: Any, detections: List[Dict[str, Any]], draw_config: Dict[str, Any]
    ) -> Any:
        """Draw bounding boxes and labels on the image.
        
        Args:
            image: PIL.Image
            detections: List of detection dicts (bbox, type, etc)
            draw_config: configuration dict
